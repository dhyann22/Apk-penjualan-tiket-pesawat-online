<table id="tabel"  border="1" cellpadding="3" >
	...
	while ($data = mysqli_fetch_array ($hasil)){
		...
		<tr>
			...
			<td class="delete">
				<a href="deletetiket.php?id_tiket=<?php echo $id ?>" onclick="return confirm('Apakah anda yakin?')" class="btn-aksi"> <img src="img/silang.png "width="35px" width:10px alt="Delete Data"></a>
			</td>
			<td class="edit">
				<a href="edittiket.php?id_tiket=<?php echo $id?>" class="btn-aksi"><img src="img/editt2.png" class="card-img-top" width="35px" alt="Edit Data"></a>
			</td>
