...
<div id="main">
  ...
  echo '<br/><br/>Data berhasil di simpan! ';  
  echo '<a href="entry_pembayaran.php" class="btn">Kembali</a>'; 
}else{

  echo 'Gagal menyimpan data! ';  
  echo '<a href="editpembayaran.php?id_pembayaran='.$id.'" class="btn">Kembali</a>'; 
